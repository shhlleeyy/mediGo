...
class HomePageWidget extends StatefulWidget {
  const HomePageWidget({
    ...
    String? mercuryDrug,
    String? rosePharmacy,
  })  : this.mercuryDrug = mercuryDrug ?? '\"Mercury Drug\"',
        this.rosePharmacy = rosePharmacy ?? '\"Rose Pharmacy\"';

  final String mercuryDrug;
  final String rosePharmacy;
                        ...
                        child: Padding(
                          ...
                          child: Autocomplete<String>(
                            ...
                            optionsBuilder: (textEditingValue) {
                              ...
                              return homePageProductsRecordList
                                  .map((e) => e.name)
                                  .toList()
                                  .where((option) {
                        ...
                        child: Builder(
                          builder: (context) {
                            final productsNoSearch =
                                homePageProductsRecordList.toList();
                                              ...
                                              child: Stack(
                                                children: [
                                                                ...
                                                                child: Padding(
                                                                  padding: EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    'In Stock:${searchResultsItem.stock.toString()}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                  ...
                                                  if (valueOrDefault<bool>(
                                                    () {
                                                      if (_model.storeChoice ==
                                                              null ||
                                                          _model.storeChoice ==
                                                              '') {
                                                        return true;
                                                      } else if (searchResultsItem
                                                              .name ==
                                                          _model.storeChoice) {
                                                        return true;
                                                      } else {
