...
import 'home_page_visitor_model.dart';
export 'home_page_visitor_model.dart';

class HomePageVisitorWidget extends StatefulWidget {
  const HomePageVisitorWidget({super.key});

  @override
  State<HomePageVisitorWidget> createState() => _HomePageVisitorWidgetState();
}

class _HomePageVisitorWidgetState extends State<HomePageVisitorWidget> {
  late HomePageVisitorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageVisitorModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> homePageVisitorProductsRecordList = snapshot.data!;
                                    ...
                                    child: Padding(
                                      ...
                                      child: Autocomplete<String>(
                                        ...
                                        optionsBuilder: (textEditingValue) {
                                          ...
                                          return homePageVisitorProductsRecordList
                                              .map((e) => e.name)
                                              .toList()
                                              .where((option) {
                                              ...
                                              () async {
                                                safeSetState(() {
                                                  _model.simpleSearchResults =
                                                      TextSearch(
                                                    homePageVisitorProductsRecordList
                                                        .map(
                                                          (record) =>
                                                              TextSearchItem
                                                                  .fromTerms(
                          ...
                          child: Builder(
                            builder: (context) {
                              final productsNoSearch =
                                  homePageVisitorProductsRecordList.toList();
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'In Stock:${productsNoSearchItem.stock.toString()}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                          .override(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.92, -0.81),
                                    child: FFButtonWidget(
                                      onPressed: () {
